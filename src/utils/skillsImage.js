...
import antdIcon from "../assets/svg/skills/icon-antd.png";
import jestIcon from "../assets/svg/skills/icon-jest.png";
import jiraIcon from "../assets/svg/skills/icon-jira.png";
import laravelIcon from "../assets/svg/skills/icon-laravel.png";
import reactTestingIcon from "../assets/svg/skills/icon-reactTestingLibrary.png";
import nodeIcon from "../assets/svg/skills/icon-nodejs.png";
import expressIcon from "../assets/svg/skills/icon-express.png";
import confluenceIcon from "../assets/svg/skills/icon-confluence.png";
import gitIcon from "../assets/svg/skills/icon-git.png";
import gitHubIcon from "../assets/svg/skills/icon-github.png";
import redmineIcon from "../assets/svg/skills/icon-redmine.png";
import googleAnalyticsIcon from "../assets/svg/skills/icon-googleAnalytics.png";
